...
\Title{
  ...
  title/magyar =Diszkrét modellek alkalmazásai (fejlesztés alatt álló
változat\footnote{Terjesztése/elmentése későbbre nem ajánlott még, a friss változat
javításokkal elérhető itt: \texttt{https://github.com/nagyadam888/discrete-mod/}})
}
\Author{
